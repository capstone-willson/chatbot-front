...
class ModalVisualCategory extends HTMLElement {
	constructor() {
		super()
	...
	loadXHR() {
		...
		xhr.open(`GET`, `https://hanyang-chatbot.kro.kr:8000/v2/visualization/doughnut/category/query`)
...
customElements.define(`modal-visual-category`, ModalVisualCategory)
